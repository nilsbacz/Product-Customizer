...
// function hideScaleButton() {
//     scaleelement.setAttribute("x",-20);
//     scaleelement.setAttribute("y",-20);
// }
//
// function moveScaleElementToRectangle() {
//     let rectcornerx = Number(currentrectangle.getAttribute("x"))+Number(currentrectangle.getAttribute("width"));
//     let rectcornery = Number(currentrectangle.getAttribute("y"))+Number(currentrectangle.getAttribute("height"));
//     scaleelement.setAttribute("x",rectcornerx);
//     scaleelement.setAttribute("y",rectcornery);
// }
//
// function startScaleText(evt) {
//     selectedScale = evt.target;
//     console.log(selectedScale)
//     startscalex = scaleelement.getAttribute("x");
//     offset = getMousePosition(evt);
//     offset.x -= parseFloat(selectedScale.getAttribute("x"));
// }
//
// function scaleText(evt) {
//     if(selectedScale){
//         let coord = getMousePosition(evt);
//         selectedScale.setAttribute("x", coord.x - offset.x);
//
//         let scalex = selectedScale.getAttribute("x");
//         let sizevalue = Math.abs(startscalex - scalex);
//         sizevalue += Number(currenttextsize.replace("%",""));
//         sizevalue += "%";
//         modifyPreviewTextSize(sizevalue);
//     }
// }
//
// function endScaleText(evt) {
//     selectedScale = false;
//     startscalex = 0;
// }
